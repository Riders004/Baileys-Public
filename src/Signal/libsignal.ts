import { SessionCipher, SessionBuilder, SessionRecord, ProtocolAddress, SessionRecordList } from 'libsignal'
import { EphemeralKeyPairDeserialized } from 'libsignal'
...
function signalStorage({ creds, keys }: SignalAuthState) {
	return {
		...
		getOurIdentity: () => {
			...
			const obj: EphemeralKeyPairDeserialized = {
